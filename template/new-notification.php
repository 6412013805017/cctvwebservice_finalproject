        ...
        <div class="row" id="my-dropdown">
            <div class="col input-group" style=''>
              ...
              <div class="form-floating">
                <input type="text" class="form-control" id="user-search" placeholder="เลือกลูกค้า" value="" name="user-id" required>
            ...
            <div class="col input-group">
                ...
                <div class="form-floating">
                    <input type="text" class="form-control" id="worksite-search" placeholder="เลือกหน้างาน" value="" name="worksite-id" required>
