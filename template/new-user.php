      ...
      <div class="col mt-2">
        ...
        <div class="col container-sm p-0">
          ...
          <div class="row">
            <div class="col input-group mb-3"> 
              <div class="form-floating">
                <input type="text" class="form-control" placeholder="ชื่อ-นามสกุล" name="name-lastname" value="">
                <label>ชื่อ-นามสกุล</label>
              </div>
            </div>
            <div class="col input-group mb-3">
              <div class="form-floating">
                <input type="text" class="form-control" placeholder="เบอร์โทร" name="phone" value="">
          ...
          <div class="row">
            ...
            <div class="col input-group mb-3">
              <div class="form-floating">
                <input type="text" class="form-control" placeholder="ที่อยู่" name="address" value="">
                <label>ที่อยู่</label>
              </div>
            </div>
          </div>
