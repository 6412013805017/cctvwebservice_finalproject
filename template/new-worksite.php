      ...
      <form action="./action/insert-worksite.php" class="my-form p-0" method="POST" enctype="multipart/form-data">
        <div class="col input-group" id="user-item">
          ...
          <div class="form-floating">
            <input type="text" class="form-control" id="user-search" placeholder="รหัสประจำตัวลูกค้า" value="" name="user-id" required>
            ...
            echo '
              {
                ...
                userName: "'.$customer['name_lastname'].'",
                imgType: "'.$customer['img_type'].'"
              },
            ';
          }
