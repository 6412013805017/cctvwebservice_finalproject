...
<body>
  ...
  <div class="container my-container">
    ...
    <form class="about-user mt-3" action="./action/update-account.php?img-type=&user-id=" method="POST" enctype="multipart/form-data">
          ...
          <div class="row mt-2">
            <div class="col input-group mb-3"> 
              <div class="form-floating">
                <input type="text" class="form-control disabled" placeholder="ชื่อผู้ใช้" value="" readonly>
                <label>ชื่อผู้ใช้</label>
              </div>
            </div>
            <div class="col input-group mb-3">
              <div class="form-floating">
                <input type="password" class="form-control" placeholder="รหัสผ่าน"  value="" readonly>
