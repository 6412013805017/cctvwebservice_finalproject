...
<body>
    ...
    <div class="container my-container text-center">
        <div class="row mt-3 mb-3 justify-content-center">
            <form action="./action/update-worksite.php?worksite-id=&user-id=" class="my-form p-0" method="POST" enctype="multipart/form-data">
                <div class="d-flex align-items-center justify-content-between">
                    <a href="./worksite-details.php?worksite-id=&user-id=" class="btn btn-primary btn-sm me-1">ย้อนกลับ</a>
                    <a href="./action/delete-worksite.php?worksite-id=&user-id=" class="btn btn-danger btn-sm me-1">ลบหน้างาน</a>
                </div>
                <div class="col mt-3">
                ...
                <div class="d-flex">
                    ...
                    <div class="img-list p-0" id="image-list">
                            <div class="img-list-item">
                                ...
                                <a href="./action/delete-worksite-img.php?image-id=&image-name=&worksite-id=&user-id=" class="img-btn-delete delete-img">
                ...
                <div class="col input-group mb-3"> 
                    ...
                    <input type="text" class="form-control" placeholder="ชื่อหน้างาน" name="worksite-name" required value="">
                    <label>ชื่อหน้างาน</label>
                    </div>
                </div>
                <div class="col input-group mb-3">
                    <div class="form-floating">
                    <input type="text" class="form-control" placeholder="ที่อยู่หน้างาน" name="address" required value="">
                ...
                <div class="col input-group mb-3"> 
                    <div class="form-floating">
                    <input type="number" class="form-control" placeholder="จำนวนกล้องวงจรปิด" name="camera-number" min="1" value="" required>
                    <label>จำนวนกล้องวงจรปิด</label>
                    </div>
                </div>
                <div class="col input-group mb-3">
                    <div class="form-floating">
                    <input type="date" class="form-control" placeholder="วันที่ติดตั้ง" id="install-date" name="install-date" required value="">
