...
<body>
  ...
  <div class="container my-container">
    ...
    <form action="./action/update-user.php?img-type=&user-id=" class="about-user mt-3" method="POST" enctype="multipart/form-data">
      ...
      <div class="user-info ps-5">
        <div class="profile-nav pe-0">
          <ul class="nav nav-tabs">
            ...
            <li class="nav-item">
              <a class="nav-link" href="./password-manage.php?user-id=">เปลี่ยนรหัสผ่าน</a>
            </li>
            <li class="nav-item">
        ...
        <div class="col mt-4">
          <div class="row">
            <div class="col input-group mb-3"> 
              <div class="form-floating">
                <input type="text" class="form-control" placeholder="ชื่อ-นามสกุล" value="" name="name_lastname" id="name_lastname">
                <label>ชื่อ-นามสกุล</label>
              </div>
            </div>
            <div class="col input-group mb-3">
              <div class="form-floating">
                <input type="text" class="form-control" placeholder="เบอร์โทร" value="" name="phone" id="phone">
          ...
          <div class="row">
            <div class="col input-group mb-3"> 
              <div class="form-floating">
                <input type="text" class="form-control" placeholder="อีเมล์" value="" name="email" id="email">
                <label>อีเมล์</label>
              </div>
            </div>
            <div class="col input-group mb-3">
              <div class="form-floating">
                <input type="text" class="form-control" placeholder="ที่อยู่" value="" name="address" id="address">
                <label>ที่อยู่</label>
              </div>
            </div>
          </div>
