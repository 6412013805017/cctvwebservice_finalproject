        ...
        <div class="row mt-3 mb-3 justify-content-center">
            <form action="" class="my-form p-0">
                <div class="d-flex align-items-center justify-content-between">
                    <a href="./?user-id=" class="btn btn-primary btn-sm me-1">กลับไปที่หน้าโปรไฟล์</a>
                    <a href="./form-update-worksite.php?worksite-id=&user-id=" class="btn btn-warning btn-sm me-1">แก้ไขข้อมูล</a>
                </div>
                <div class="col mt-3">
                ...
                <div class="d-flex">
                    ...
                    <div class="img-list p-0" id="image-list">
                            <div class="img-list-item">
                                <img src="../../uploads/worksite-img/" alt="">
                            </div>
                    </div>
                    </div>
                </div>
                ...
                <div class="col input-group mb-3"> 
                    ...
                    <input type="text" class="form-control" placeholder="ชื่อหน้างาน" name="worksite-name" required value="" disabled>
                    <label>ชื่อหน้างาน</label>
                    </div>
                </div>
                <div class="col input-group mb-3">
                    <div class="form-floating">
                    <input type="text" class="form-control" placeholder="ที่อยู่หน้างาน" name="address" required value=""  disabled>
                ...
                <div class="col input-group mb-3"> 
                    <div class="form-floating">
                    <input type="number" class="form-control" placeholder="จำนวนกล้องวงจรปิด" name="camera-number" min="1" value="" required  disabled>
                    <label>จำนวนกล้องวงจรปิด</label>
                    </div>
                </div>
                <div class="col input-group mb-3">
                    <div class="form-floating">
                    <input type="date" class="form-control" placeholder="วันที่ติดตั้ง" id="install-date" name="install-date" required value=""  disabled>
                    <label>วันที่ติดตั้ง</label>
                    </div>
                </div>
                </div>
                <div class="col">
                <textarea name="other-details" id="" class="form-control" rows="5" style="padding: 10px; border-radius: 5px;" placeholder="รายละเอียดเพิ่มเติม" disabled></textarea>
                </div>
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td class="text-start">
                                ...
                                <p class="m-0 text-muted" style="font-size: 12px;">วันที่แจ้งปัญหา : </p>
                            </td>
                            <td class="text-start">
                            </td>
                            <td class="text-start">
                                
                                    <p class="m-0 text-muted" style="font-size: 12px;">วันที่ให้บริการ : </p>
                            ...
                            <td class="text-center">
                                <div class="d-flex align-items-center justify-content-center">
                                        ...
                                        <div class="me-2" style="width: 5px; height: 5px; border-radius: 50%; background-color: yellow;"></div><a href='../service.php?noti-id=' style="color: black;">กำลังดำเนินการ</a>
                                    
                                        <div class="me-2" style="width: 5px; height: 5px; border-radius: 50%; background-color: gray;"></div><a href='../service.php?noti-id=' style="color: black;">ดำเนินการแล้ว</a>
